...
- [x] Prepare, owner-approve, apply, and read-only verify the Supabase atomic paid-credit RPC on 2026-06-14.
- [x] Explicitly approve and deploy the Render RPC feature-flag cutover on 2026-06-14.
- [ ] Verify one controlled Creem test-mode payment through the atomic RPC before any live payment test.
...
- [x] Sent an external message and confirmed the recipient sees `FrameVela AI Support <support@cozyguidehub.com>`.
