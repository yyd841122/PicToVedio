...
| Atomic credits | Read-only production preflight returned zero rows on 2026-06-14; RPC installation and test-mode verification still require explicit approval |
